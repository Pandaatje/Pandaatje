      ...
      _disableDatepicker: function(target) {
        ...
        if (nodeName === "input") {
          ...
          inst.trigger.filter("button").
            ...
            filter("img").css({opacity: "0.5", cursor: "none"});
        } else if (nodeName === "div" || nodeName === "span") {
          inline = $target.children("." + this._inlineClass);
    ...
    */
    ...
    $.widget("ui.sortable", $.ui.mouse, {
      ...
      _mouseStart: function(event, overrideHandle, noActivation) {
        ...
        if( o.cursor && o.cursor !== "auto" ) { // cursor option
          ...
          this.storedStylesheet = $( "<style>*{ cursor: none !important; }</style>" ).appendTo( body );
        }
    ...
    (function() {
      ...
      ContactForm.validationRules = {
        ...
        name: { maxlength: 255 },
        body: { required: true, maxlength: 65535 },
      };
      ...
      ContactForm.validationMessages = {
        ...
        name: {
          maxlength: "Field length must not exceed 255 characters.",
        },
        body: {
          required: "Message must not be blank.",
          maxlength: "Message length must not exceed 65,535 characters.",
        },
      };
      ...
      ContactForm.addValidations = function(form) {
        ...
        // <input data-validate='email'> - validates presence and email format
